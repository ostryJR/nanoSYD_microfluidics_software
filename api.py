...
class Hub:
    ...
    class Pump:
        ...
        def __init__(self, pump_address, syringe_volume, high_precision=False ):#, backlash_compensation=0):
            #pump_address number on the address switch 0...E (0...15)
            #syringe volume in microliters uL

            if self.syringe_volume == 0:
        ...
        def calculate_steps(self, volume):
            ...
            return int(3000 if not self.high_precision else 24000) * volume / self.syringe_volume
        ...
        def get_status_errors(self):
            ...
            # X - bit 5 is status bit 0-pump is idle and ready for new commands, 1- pump is executing a command
...
if __name__ == "__main__":
    ...
    pumps[0].send_command("ZR")


    # pump = Pump(pump_address=0, syringe_diameter=10, com_port="COM3")
    # pump.dispense(100)
